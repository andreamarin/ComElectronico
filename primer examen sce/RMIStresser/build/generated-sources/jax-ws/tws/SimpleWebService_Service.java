 ...
 * 
 */
@WebServiceClient(name = "SimpleWebService", targetNamespace = "http://tws/", wsdlLocation = "http://localhost:8080/TestWebService/SimpleWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName SIMPLEWEBSERVICE_QNAME = new QName("http://tws/", "SimpleWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/TestWebService/SimpleWebService?WSDL");
    ...
    public SimpleWebService getSimpleWebServicePort() {
        return super.getPort(new QName("http://tws/", "SimpleWebServicePort"), SimpleWebService.class);
    }
    ...
    public SimpleWebService getSimpleWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tws/", "SimpleWebServicePort"), SimpleWebService.class, features);
    }
